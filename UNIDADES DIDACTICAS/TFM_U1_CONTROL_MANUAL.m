...
voltaje_paso =1.0 ; % Voltaje a aplicar para el movimiento. (+voltaje +velocidad)
duracion_paso = 0.1; % Tiempo en segundos que el motor está encendido por cada pulsación.
